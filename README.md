...
## Bonus Features
Not a fan of the default voice lines? Customize what the Masked can say by editing the following files:
...
## Credits
Credit to @Kalthun and @notgarrett for helping me test this mod
